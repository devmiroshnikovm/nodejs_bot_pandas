...
filtered_df = df[df['property_usage_en'] == 'Commercial']
...
plt.title('Number of Commercial Transactions by Year')

# Save the plot to a file
plt.savefig("transactions_by_years_commertial.png", dpi=300)
